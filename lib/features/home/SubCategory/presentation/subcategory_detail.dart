        ...
        children: [
          BlocBuilder<SubcategoryCubit, SubCategoryDetailState>(
            ...
            builder: (context, state) {
              ...
              return _buildDynamicDropdown<SubCategory_new>(
                hintText:
                    context.read<SubcategoryCubit>().SelectedSubcategoryname ??
                        'Select Subcategory',
                value: context
                ...
                items: context.read<SubcategoryCubit>().subcategorieslist ?? [],
                itemBuilder: (subcategory) => DropdownMenuItem<SubCategory_new>(
                  value: subcategory,
                  child: Text(subcategory.name),
                ),
                onChanged: (newValue) {
                      ...
                      ? context.read<SubcategoryCubit>().states.firstWhere(
                            (stateItem) =>
                                ...
                                context
                                    ...
                                    .SelectedStatename,
                            orElse: () =>
                                context.read<SubcategoryCubit>().states.first,
                          )
                      : null,
                  // Handle empty or null list
          ...
          BlocBuilder<SubcategoryCubit, SubCategoryDetailState>(
            ...
            builder: (context, state) {
              ...
              if (state is GetAllDistrictSuccessState) {
                return Visibility(
                  ...
                  child: _buildDynamicDropdown<DistrictModel>(
                    ...
                    itemBuilder: (stateItem) => DropdownMenuItem<DistrictModel>(
                      value: stateItem,
                      child: Text(stateItem.name),
                    ),
                    onChanged: (newValue) {
              ...
              return Visibility(
                visible: context.read<SubcategoryCubit>().districts.isEmpty
                    ? false
                    : true,
                child: _buildDynamicDropdown<DistrictModel>(
                  hintText:
                      context.read<SubcategoryCubit>().SelectedSDistrictname ??
                          'Select District',
                  value: context.read<SubcategoryCubit>().districts.isNotEmpty
                      ? context.read<SubcategoryCubit>().districts.firstWhere(
                            (stateItem) =>
                                stateItem.name ==
                                context
                                    .read<SubcategoryCubit>()
          ...
          BlocBuilder<SubcategoryCubit, SubCategoryDetailState>(
            ...
            builder: (context, state) {
              ...
              if (state is GetAllOrganizationSuccessState) {
                return Visibility(
                  ...
                  child: _buildDynamicDropdown<Organization>(
                    ...
                    itemBuilder: (stateItem) => DropdownMenuItem<Organization>(
                      value: stateItem,
                      child: Text(stateItem.name),
                    ),
                    onChanged: (newValue) {
              ...
              return Visibility(
                visible: context.read<SubcategoryCubit>().organizations.isEmpty
                    ? false
                    : true,
                child: _buildDynamicDropdown<Organization>(
                  hintText: context
                      ...
                      'Select Organization',
                  value:
                      context.read<SubcategoryCubit>().organizations.isNotEmpty
                          ? context
                              .read<SubcategoryCubit>()
                              .organizations
                              .firstWhere(
